...
import { Heart, MessageCircle, Bookmark, Repeat, Play } from "lucide-react";
...
export default function FollowingFeedPage() {
  ...
  useEffect(() => {
    fetch("/api/vibes/feed/following")
      .then((r) => r.json())
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-gold animate-pulse">Loading your feed...</div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black pt-20 pb-12 px-4">
      <div className="container mx-auto max-w-2xl">
        <h1 className="text-2xl font-bold text-gold mb-6">Following</h1>
        {posts.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-white/50">Follow some creators to see their posts here</p>
